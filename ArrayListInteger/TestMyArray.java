...
public class TestMyArray
{
   ...
   //public static void printArray(String msg, ArrayList<Integer> a)
   {
      if (msg != null)
   ...
   public static void main(String[] args)
   {
      ...
      int badVal = myList.get(myList.size());
   
      System.out.println("testing invalid remove");
      badVal = myList.remove(myList.size() + 1);
